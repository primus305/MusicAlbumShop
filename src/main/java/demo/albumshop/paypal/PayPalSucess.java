...
public class PayPalSucess {
    ...
    public PayPalResult getPayPal(HttpServletRequest request, PayPalConfig payPalConfig) {
        ...
        try {
            ...
            req.getOutputStream().write(query.getBytes());
            System.out.println(req.getRequestMethod());
            OutputStreamWriter outputStream = new OutputStreamWriter(req.getOutputStream());
            ...
            System.out.println(e.getMessage() + " blejaz");
            payPalResult = null;
        }
